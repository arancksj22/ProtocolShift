...
|---|---|---|---|---|---|---|
| mongo | 10 | 100B | PASS (53.8%) | fail | PASS (not measured) | HOLD |
| postgres | 10 | 100B | PASS (77.9%) | fail | PASS (not measured) | HOLD |
| redis | 10 | 100B | PASS (73.6%) | fail | PASS (not measured) | HOLD |
