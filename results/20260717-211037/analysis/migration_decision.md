...
|---|---|---|---|---|---|---|
| mongo | 10 | 100B | PASS (43.6%) | fail | PASS (not measured) | HOLD |
| postgres | 10 | 100B | PASS (76.0%) | fail | PASS (not measured) | HOLD |
| redis | 10 | 100B | PASS (65.1%) | fail | PASS (not measured) | HOLD |
