...
|---|---|---|---|---|---|---|
| mongo | 10 | 100B | PASS (50.1%) | fail | PASS (not measured) | HOLD |
| postgres | 10 | 100B | PASS (73.6%) | fail | PASS (not measured) | HOLD |
| redis | 10 | 100B | PASS (80.7%) | fail | PASS (not measured) | HOLD |
